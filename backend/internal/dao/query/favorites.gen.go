...
func newFavorite(db *gorm.DB, opts ...gen.DOOption) favorite {
	...
	_favorite.Key = field.NewString(tableName, "key")
	_favorite.Title = field.NewString(tableName, "title")
	_favorite.SourceName = field.NewString(tableName, "source_name")
	_favorite.Cover = field.NewString(tableName, "cover")
	_favorite.Year = field.NewString(tableName, "year")
	_favorite.TotalEpisodes = field.NewInt32(tableName, "total_episodes")
	_favorite.SaveTime = field.NewTime(tableName, "save_time")
...
func (f *favorite) updateTableName(table string) *favorite {
	...
	f.SourceName = field.NewString(table, "source_name")
	f.Cover = field.NewString(table, "cover")
	f.Year = field.NewString(table, "year")
	f.TotalEpisodes = field.NewInt32(table, "total_episodes")
	f.SaveTime = field.NewTime(table, "save_time")
...
func (f *favorite) fillFieldMap() {
	...
	f.fieldMap["source_name"] = f.SourceName
	f.fieldMap["cover"] = f.Cover
	f.fieldMap["year"] = f.Year
	f.fieldMap["total_episodes"] = f.TotalEpisodes
	f.fieldMap["save_time"] = f.SaveTime
}
